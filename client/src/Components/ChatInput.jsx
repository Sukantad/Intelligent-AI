...
function ChatInput({ Question, setLoading, data, setdata }) {
    ...
    return (
        <Box fontFamily={'Lora'} w={["95%", "80%"]} display={'flex'} h="10vh" m="auto" boxShadow='dark-lg' mt="10px" p="15px" borderRadius={'10px'}>
            <Img pr="5px" h="38px" _hover={{ cursor: "pointer" }} onClick={() => { SpeechRecognition.startListening(); handleStart() }} src="https://www.iconpacks.net/icons/1/free-microphone-icon-342-thumb.png" />
            <Input h="40px" color={'blue'} type="text" ref={ref} value={text?text:transcript}  onKeyPress={ClickHandler} onKeyUp={resetTranscript} onChange={voiceHandler} placeholder="Type whatever you want" />
